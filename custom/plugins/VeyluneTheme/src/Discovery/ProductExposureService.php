...
final class ProductExposureService
{
    ...
    private const EXPOSURE_REGISTRY = [
        'VLS-FUR-000001' => [
            ...
            'rooms' => ['living-room'],
            'collections' => ['quiet-living', 'founder-selection'],
            'materials' => ['upholstery_fabric'],
            'consultation' => true,
        ],
        'VLS-FUR-000002' => [
            'approved' => false,
        ...
        'VLS-FUR-000009' => [
            ...
            'founderApproved' => false,
            'categories' => ['furniture'],
            'rooms' => ['hallway', 'bedroom', 'dining-room'],
            'collections' => ['quiet-living'],
            'materials' => ['wood'],
            'consultation' => false,
        ],
        'VLS-FUR-000010' => [
            ...
            'categories' => ['furniture'],
            'rooms' => ['living-room'],
            'collections' => ['material-forms', 'founder-selection'],
    ...
    private const GOVERNED_MATERIAL_OPTIONS = [
        'Polsterstoff' => 'upholstery_fabric',
        'Upholstery Fabric' => 'upholstery_fabric',
